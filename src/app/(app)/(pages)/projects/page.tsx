...
const description = "A collection of things I've built."
...
function getBlogJsonLd(
  ...
  return {
    ...
    blogPost: posts.map((post) => ({
      "@type": "BlogPosting",
      "@id": absoluteUrl(`/projects/${post.slug}`),
    ...
    <>
      ...
      <div className="min-h-svh">
        <PageHeading>
          ...
          <PageHeadingTitle>A collection of things I've built.</PageHeadingTitle>
        </PageHeading>
